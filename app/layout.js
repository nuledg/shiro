...
export const metadata = {
	title: "Shiro Wear",
	description: "فروشگاه اینترنتی لباس مردانه شیرو",
};
...
export default function RootLayout({ children }) {
	return (
		<html lang="fa" dir="rtl">
			<body
				className={`${vazirmatn.className} p-2 min-h-screen bg-gradient-to-t from-black to-gray-950`}
			>
				<div className="flex flex-col text-center justify-center mt-8 p-1 ">
					<header className="">
						<h1 className="text-8xl mt-5 mb-12 antialiased font-semibold">
							شیـرو
						</h1>
						<h2 className="text-[23px] text-gray-500 antialiased font-medium">
							فروشگاه پوشاک شیرو
						</h2>
						<h3 className="text-xs my-2 text-gray-600 antialiased">
							ارسال رایگان | ضمانت بازگشت | پرداخت امن
						</h3>
					</header>
					<div className="my-8 w-3/4 mx-auto h-px border-t-0 bg-transparent bg-gradient-to-r from-transparent via-neutral-500 to-transparent opacity-25 dark:opacity-100"></div>
					<div className="p-2 my-auto mt-4 md:mt-10">{children}</div>
				</div>
				<div className="mx-auto bg-black flex justify-center items-center z-20 p-2 fixed left-1/2 transform -translate-x-1/2 bottom-16 sm:translate-x-0 w-20 h-10 sm:p-4 border-2 border-gray-700 sm:rounded-full sm:w-28 sm:h-28 sm:left-0 lg:left-36 sm:bottom-10 transition-all duration-300">
					<svg
						id="logo-11"
						width="119"
						height="30"
				...
				<nav className="flex border-gray-700 border-t-2 w-full list-none items-end justify-center fixed bottom-0 inset-x-0 py-4 z-10 bg-black">
					<li className="menu-item">
						<Link className="hover:text-white transition duration-500" href="/">
							{" "}
							صفحه اصلی{" "}
						</Link>
					</li>
